function postComment(){
    $('#button_post_comment').on('click', function replaceWords(e) {
        ...
        $.post('/post_comment_three', {com_name: selected_name, com_email: selected_email, com_text: remove_links}, function(data) {
            console.log(data);
        });
...
function getMostCommonWords() {
    ...
    $.get('/get_most_common_words_three', function (data) {
		var words = [];
		var no_words_app = [];
		console.log(data);
